...
<dnn:DnnJsInclude ID="DnnJsanimateNumber" runat="server" FilePath="assets/js/jquery.animateNumber.min.js" PathNameAlias="SkinPath" ForceProvider="DnnFormBottomProvider" Name="animateNumber" Version="0.0.14" />
